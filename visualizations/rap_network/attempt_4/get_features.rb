...
def get_artist_object(artist_name)
    ...
    if (artist_name == 'Devin the Dude')
        # Annoying special case, still not sure why it's happening
        return RapGenius.search_by_artist(artist_name)[0].artists[0]
    end
